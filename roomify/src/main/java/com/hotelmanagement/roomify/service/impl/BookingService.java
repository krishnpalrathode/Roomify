...
import com.hotelmanagement.roomify.repo.UserRepository;
import com.hotelmanagement.roomify.service.interfac.IBookingService;
...
public class BookingService implements IBookingService {
    ...
    public Response saveBooking(Long roomId, Long userId, Booking bookingRequest) {
        ...
        try {
            ...
            String bookingConfirmationCode = Utils.genrateRandomAlphanumeric(10);
    ...
    public Response cancelBooking(Long bookingId) {
        ...
        try {
            bookingRepository.findById(bookingId)
                    .orElseThrow(() -> new OurException("Booking does not exists"));
