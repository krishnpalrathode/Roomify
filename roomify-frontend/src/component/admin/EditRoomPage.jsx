        ...
        const fetchRoomDetails = async () => {
            try {
                const response = await ApiService.getRoomById(roomId);
                 console.log('Room data from API:', response.room);
                setRoomDetails({
                ...
                <div className="form-group">
                    {preview ? (
                        ...
                        roomDetails.roomPhotoUrl && (
                            <img src={roomDetails.roomPhotoUrl.startsWith('http') 
                ? roomDetails.roomPhotoUrl 
                : `http://localhost:4040/Images/${room.roomPhotoUrl}`} alt="Room" className="room-photo" />
                        )
                    )}
                    <input
                        type="file"
